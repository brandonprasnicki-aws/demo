...
#step 1
module "TransitGW" {
  source      = "../../modules/modules/TransitGW"
...
module "TransitGW_Network_Inspection_Attachment" {
  source                 = "../../modules/modules/TransitGWAttachment"
...
module "TransitGW_to_Inspection_routes" {
  source      = "../../modules/modules/TransitGWRouteTable"
  common_tags = var.common_tags
...
module "Dev_TransitGW_Attach_Accept" {
  source = "../../modules/modules/TransitGW_Attach_Accept"
